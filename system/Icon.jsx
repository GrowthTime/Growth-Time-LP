// GT System — Lucide icon set (inline SVG paths, viewBox 0 0 24 24, stroke 2, round)
// Exposes window.Icon (React component).
const GT_ICONS = {
  ...
  'sparkles': '<path d="M9.94 14.06A2 2 0 0 0 8.5 12.6l-5.6-1.44a.5.5 0 0 1 0-.96L8.5 8.76A2 2 0 0 0 9.94 7.3l1.44-5.6a.5.5 0 0 1 .96 0l1.44 5.6a2 2 0 0 0 1.44 1.44l5.6 1.44a.5.5 0 0 1 0 .96l-5.6 1.44a2 2 0 0 0-1.44 1.44l-1.44 5.6a.5.5 0 0 1-.96 0z"/><path d="M20 3v4"/><path d="M22 5h-4"/>',
  ...
  'paperclip': '<path d="M13.234 20.252 21 12.3a4 4 0 0 0-5.7-5.6l-8.5 8.7a6 6 0 1 0 8.5 8.5l6.7-6.9"/>',
...
function Icon({ name, size = 18, color = 'currentColor', strokeWidth = 2, style = {}, className = '' }) {
  const inner = GT_ICONS[name] || '';
  return (
    <svg
